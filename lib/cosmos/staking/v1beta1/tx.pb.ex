defmodule Cosmos.Staking.V1beta1.MsgCreateValidator do
  ...
  field :delegator_address, 4, type: :string, json_name: "delegatorAddress", deprecated: false
...
defmodule Cosmos.Staking.V1beta1.Msg.Service do
  @moduledoc false
  use GRPC.Service, name: "cosmos.staking.v1beta1.Msg", protoc_gen_elixir_version: "0.11.0"
